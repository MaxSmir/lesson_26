...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pSphereMesh->LoadMesh("C:/Users/sofya/source/repos/lr4 IiKG/lesson 25/Content/box.obj")) {
            return false;
        }

        m_pTexture = new Texture(GL_TEXTURE_2D, "C:/Users/sofya/source/repos/lr4 IiKG/lesson 25/Content/bricks.jpg");
        ...
        m_pNormalMap = new Texture(GL_TEXTURE_2D, "C:/Users/sofya/source/repos/lr4 IiKG/lesson 25/Content/normal_map.jpg");

        if (!m_pNormalMap->Load()) {
            return false;
        }

        m_pTrivialNormalMap = new Texture(GL_TEXTURE_2D, "C:/Users/sofya/source/repos/lr4 IiKG/lesson 25/Content/normal_up.jpg");
